            ...
            <div className='bg-white p-8 rounded-lg shadow-lg w-96 relative'>
                ...
                <div className='flex items-center justify-center mb-4'>
                    {Array.from({ length: 5 }, (_, i) => (
                        <Star
                            key={i}
                            className={`size-8 cursor-pointer ${rating > i ? "text-navy-400 fill-current" : "text-gray-300"}`}
                ...
                ></textarea>
                <button onClick={e => toast.promise(handleSubmit(), { loading: 'Submitting...' })} className='w-full bg-navy-500 text-white py-2 rounded-md hover:bg-navy-600 transition'>
                    Submit Rating
                </button>
            </div>
        </div>
